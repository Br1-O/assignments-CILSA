export const validationForm = (maxLengthValidation, minLengthValidation, nameValidation, emailValidation) => {

    //contact form
        const formContact = document.querySelector('#form-contact');
    //contact input fields
        const nameField = document.querySelector('#form-contact .row .col-12 .input-group input[name="fullName"]');
        const lastNameField = document.querySelector('#form-contact .row .col-12 .input-group input[name="lastName"]');
    ...
    //contact error messages
        ...
        const lastNameErrorMessage = document.getElementById('errorLastNameContactForm');
    ...
    formContact.addEventListener("submit", (event) => {
        ...
        try {
            ...
            if (isNameValid) {
                isLastNameValid= nameValidation(lastNameField, lastNameErrorMessage);
            }
